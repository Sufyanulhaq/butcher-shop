	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand"><img src='./product_images/logo.png'  width='150px' height='40px' style='margin-top:-10px'/></a>
			</div>
...
<div class="row">
	<div class="col-md-12">
		<img src='./product_images/slider.jpg' style='padding:10px' />
		
		<h1 class='text-center ' style='margin-top:-300px;color:white'>Home  Page</h1>
	</div>
</div>
	<!-- home images end -->
